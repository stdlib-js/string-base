...
```javascript
import string from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base@v0.0.0-esm/index.mjs';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base@v0.0.0-esm/index.mjs';
