...
```javascript
import string from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base@v0.1.0-deno/mod.js';
```
...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base@v0.1.0-deno/mod.js';
