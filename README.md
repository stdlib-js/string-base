...
```javascript
import string from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base@v0.1.1-esm/index.mjs';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base@v0.1.1-esm/index.mjs';
...
[test-image]: https://github.com/stdlib-js/string-base/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/string-base/actions/workflows/test.yml?query=branch:v0.1.1
