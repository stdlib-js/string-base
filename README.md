...
```javascript
import string from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base@v0.2.1-esm/index.mjs';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base@v0.2.1-esm/index.mjs';
